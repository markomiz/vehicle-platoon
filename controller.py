...
class Controller:
    def __init__(self, kp=0.0, ki=0.0, kd=0.0, k_path=0.5, k_heading=2.0):
    ...
    def compute_control(self, following_state, current_state, dt):
        ...
        path_error = dist * np.sin(desired_state[2]) * sign
        long_error = dist * np.cos(desired_state[2])
